...
const CalendarEventSchema = CollectionSchema(
  ...
  links: {
    r'linkedTask': LinkSchema(
      id: 487387763094258143,
      name: r'linkedTask',
      target: r'Task',
      single: true,
    ),
...
void _calendarEventAttach(
  ...
  object.id = id;
  object.linkedTask.attach(col, col.isar.collection<Task>(), r'linkedTask', id);
}
...
extension CalendarEventQueryWhereSort
  ...
  QueryBuilder<CalendarEvent, CalendarEvent, QAfterWhere> anyTitleLower() {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(
...
extension CalendarEventQueryWhere
  ...
  titleLowerEqualTo(String titleLower) {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(
  ...
  QueryBuilder<CalendarEvent, CalendarEvent, QAfterWhereClause>
  titleLowerGreaterThan(String titleLower, {bool include = false}) {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(
        IndexWhereClause.between(
          indexName: r'titleLower',
  ...
  QueryBuilder<CalendarEvent, CalendarEvent, QAfterWhereClause>
  titleLowerLessThan(String titleLower, {bool include = false}) {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(
        IndexWhereClause.between(
          indexName: r'titleLower',
  ...
  QueryBuilder<CalendarEvent, CalendarEvent, QAfterWhereClause>
  titleLowerStartsWith(String TitleLowerPrefix) {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(
        IndexWhereClause.between(
          indexName: r'titleLower',
...
extension CalendarEventQueryFilter
  ...
  QueryBuilder<CalendarEvent, CalendarEvent, QAfterFilterCondition>
  titleLowerEqualTo(String value, {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(
        FilterCondition.equalTo(
  ...
  QueryBuilder<CalendarEvent, CalendarEvent, QAfterFilterCondition>
  titleLowerStartsWith(String value, {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(
        FilterCondition.startsWith(
          property: r'titleLower',
  ...
  QueryBuilder<CalendarEvent, CalendarEvent, QAfterFilterCondition>
  titleLowerEndsWith(String value, {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(
        FilterCondition.endsWith(
          property: r'titleLower',
...
extension CalendarEventQueryLinks
    on QueryBuilder<CalendarEvent, CalendarEvent, QFilterCondition> {
  QueryBuilder<CalendarEvent, CalendarEvent, QAfterFilterCondition> linkedTask(
    FilterQuery<Task> q,
  ) {
    return QueryBuilder.apply(this, (query) {
      return query.link(q, r'linkedTask');
    });
  }
  ...
  linkedTaskIsNull() {
    return QueryBuilder.apply(this, (query) {
      return query.linkLength(r'linkedTask', 0, true, 0, true);
    });
  }
}
...
extension CalendarEventQuerySortBy
  ...
  QueryBuilder<CalendarEvent, CalendarEvent, QAfterSortBy> sortByColor() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'color', Sort.asc);
    });
  }

  QueryBuilder<CalendarEvent, CalendarEvent, QAfterSortBy> sortByColorDesc() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<CalendarEvent, CalendarEvent, QAfterSortBy> sortByTitleLower() {
    return QueryBuilder.apply(this, (query) {
...
extension CalendarEventQuerySortThenBy
  ...
  QueryBuilder<CalendarEvent, CalendarEvent, QAfterSortBy> thenByColor() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'color', Sort.asc);
    });
  }

  QueryBuilder<CalendarEvent, CalendarEvent, QAfterSortBy> thenByColorDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'color', Sort.desc);
    });
  }
  ...
  QueryBuilder<CalendarEvent, CalendarEvent, QAfterSortBy> thenByTitleLower() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'titleLower', Sort.asc);
    });
  }
...
extension CalendarEventQueryWhereDistinct
  ...
  QueryBuilder<CalendarEvent, CalendarEvent, QDistinct> distinctByColor() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<CalendarEvent, CalendarEvent, QDistinct> distinctByTitleLower({
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
...
extension CalendarEventQueryProperty
  ...
  QueryBuilder<CalendarEvent, int?, QQueryOperations> colorProperty() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<CalendarEvent, String, QQueryOperations> titleLowerProperty() {
    return QueryBuilder.apply(this, (query) {
